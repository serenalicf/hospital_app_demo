...
public class HttpClientUtil {
    ...
    /**
     * Send a Post request using the specified character encoding.
     *
     * @param url
     * @param body RequestBody
     * @param mimeType e.g., application/xml, "application/x-www-form-urlencoded" a=1&b=2&c=3
     * @param charset encoding
     * @param connTimeout connection timeout in milliseconds
     * @param readTimeout response timeout in milliseconds
     * @return ResponseBody using the specified character encoding
     * @throws ConnectTimeoutException connection timeout exception
