package com.serena.serviceutil.helper;

import com.alibaba.fastjson.JSONObject;
import com.serena.serviceutil.utils.HttpUtil;
...
public class HttpRequestHelper {
    ...
    /**
     * Convert request parameter map to standard map
     * @param paramMap
     * @return
     */
    ...
    public static JSONObject sendRequest(Map<String, Object> paramMap, String url){
        String result = "";
        try {
            //Package post parameters
            StringBuilder postdata = new StringBuilder();
            for (Map.Entry<String, Object> param : paramMap.entrySet()) {
                postdata.append(param.getKey()).append("=")
                        .append(param.getValue()).append("&");
            }
            log.info(String.format("--> Sending request: post data %1s", postdata));
